...
// TestBooleanExpressions() tests whether the VM can evaluate boolean expressions.
...
// TestConditionals() tests whether the VM can evaluate conditionals.
...
// testBooleanObject() tests the boolean object.
